...
Torch is configured using environment variables that control its behavior and integration with FHIR servers. This allows
...
When running TORCH **dockerized**, it is recommended to set these variables for the Docker container or pass them as

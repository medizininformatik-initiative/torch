...
1. TORCH retrieves all patient **Consent** resources from the FHIR server.
2. For the current extraction request the valid consent records are identified based on:
    - Patient ID
    - Status
    - Provision codes

3. Shift start of Consent by related Encounter if applicable:
    ...
    -
4. During extraction TORCH determines:

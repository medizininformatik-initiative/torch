...
import de.medizininformatikinitiative.torch.exceptions.*;
...
public class ResourceTransformer {
    ...
    public Flux<Resource> transformResources(String parameters, AttributeGroup group) {
        ...
        return resources.map(resource -> {
            ...
            } catch (NoSuchMethodException | IllegalAccessException | MustHaveViolatedException e) {
    ...
    public Mono<Map<String, Collection<Resource>>> collectResourcesByPatientReference(Crtdl crtdl, List<String> patients) {
        return collectResourcesByPatientReference(crtdl, patients, batchSize);
    }

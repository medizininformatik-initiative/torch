...
public class ConsentValidator {
    ...
    public boolean checkConsent(DomainResource resource, PatientBatchWithConsent patientBatchWithConsent) {
        ...
        if (patientResourceBundle == null) {
            logger.warn("CONSENT_VALIDATOR_0001 No PatientResourceBundle found for patient ID: {} in resource {}", patientID, resource.getId());
            return false;
        }
    ...
    public boolean checkConsent(DomainResource resource, PatientResourceBundle patientResourceBundle) {
        ...
        if (fieldValue == null) {
            logger.warn("CONSENT_VALIDATOR_0002 No supported ResourceType found for resource of type: {}", resource.getResourceType());
            return false;
        }

...
public class ProvisionExtractor {
    ...
    public ConsentProvisions extractProvisionsPeriodByCode(Consent consent, Set<String> requiredCodes) throws ConsentViolatedException, PatientIdNotFoundException {
        ...
        List<Consent.ProvisionComponent> provisionPeriodList = consent.getProvision().getProvision();
        ...
        for (Consent.ProvisionComponent provision : provisionPeriodList) {
        ...
        return new ConsentProvisions(ResourceUtils.patientId(consent), consentTime, provisions);
    }

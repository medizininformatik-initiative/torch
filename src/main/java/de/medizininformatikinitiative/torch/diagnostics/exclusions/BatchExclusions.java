...
public class BatchExclusions {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BatchExclusions other)) {
            return false;
        }
        return this.getResourceExclusions().equals(other.getResourceExclusions()) &&
                this.getPatientExclusions().equals(other.getPatientExclusions());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getPatientExclusions(), getResourceExclusions());
    }

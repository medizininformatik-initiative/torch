...
public class JobPersistenceService {
    ...
    public JobDiagnosticSummary loadJobSummary(UUID jobId) throws IOException {
    ...
    public boolean rawProvisionsExists(UUID jobId) {
        return diagnosticsStore.rawProvisionsExists(jobDir(jobId));
    }

    public boolean finalPeriodsExists(UUID jobId) {
        return diagnosticsStore.finalPeriodsExists(jobDir(jobId));
    }

    public boolean consentConsideredResourcesExists(UUID jobId) {
        return diagnosticsStore.consentConsideredResourcesExists(jobDir(jobId));
    }

            ...
            if (elements.isEmpty()) {
                ...
                if (elements.size() == 1) {
                    ...
                    if (terserFHIRPATH.endsWith("[x]")) {
                        logger.info("Tersertobehandled {}",terserFHIRPATH);

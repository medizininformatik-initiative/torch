...
class ConsentAdjusterUnitTest {
    ...
    void testFetchAndAdjust_skipsEncounterWithoutPatientId() {
        ...
        StepVerifier.create(adjuster.fetchEncounterAndAdjustByEncounter(batch, List.of(consent)))
                .assertNext(updated -> {
    ...
    void testFetchAndAdjust_withMockedDataStore() {
        ...
        StepVerifier.create(adjuster.fetchEncounterAndAdjustByEncounter(batch, List.of(consent1, consent2)))
                .assertNext(updated -> {

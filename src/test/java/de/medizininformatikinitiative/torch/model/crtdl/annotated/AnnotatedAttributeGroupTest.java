...
class AnnotatedAttributeGroupTest {
    ...
    class Queries {
        ...
        void oneCode() {
            ...
            var attributeGroup = new AnnotatedAttributeGroup("test", "groupRef", List.of(new AnnotatedAttribute("Observation.name", "Observation.name", "Observation.name", false)), List.of(tokenFilter));
        ...
        void dateFilter() {
            ...
            var attributeGroup = new AnnotatedAttributeGroup("test", "groupRef", List.of(new AnnotatedAttribute("Observation.name", "Observation.name", "Observation.name", false)), List.of(dateFilter));
        ...
        void filtersIgnoredForPatient() {
            var dateFilter = new Filter("date", "date", DATE_START, DATE_END);
            var attributeGroup = new AnnotatedAttributeGroup("test", "groupRef", List.of(new AnnotatedAttribute("Patient.name", "Patient.name", "Patient.name", false)), List.of(dateFilter));

...
class AnnotatedAttributeGroupTest {
    ...
    class Queries {
        ...
        void oneCode() {
            ...
            var attributeGroup = new AnnotatedAttributeGroup("test", "groupRef", List.of(new AnnotatedAttribute("Patient.name", "Patient.name", "Patient.name", false)), List.of(tokenFilter), null);

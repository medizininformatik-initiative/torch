...
class BatchCopierRedacterIT {
    ...
    class transformResource {
        ...
        void testResourceWithKnownGroups() throws TargetClassCreationException, MustHaveViolatedException {
            ...
            Resource result = batchCopierRedacter.transform(new ExtractionRedactionWrapper(condition, Set.of(CONDITION_PROFILE), Map.of("Condition.subject", Set.of("Patient/VHF00006")), conditionGroup.buildTree()));

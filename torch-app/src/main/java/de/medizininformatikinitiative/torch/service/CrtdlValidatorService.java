...
public class CrtdlValidatorService {
    ...
    public CrtdlValidatorService(StructureDefinitionHandler profileHandler, StandardAttributeGenerator attributeGenerator, ConsentEvaluator consentEvaluator, FhirPathBuilder fhirPathBuilder, FhirContext fhirContext) {
    ...
    public AnnotatedCrtdl validateAndAnnotate(Crtdl crtdl) throws ValidationException, ConsentFormatException {
        consentEvaluator.validate(crtdl);

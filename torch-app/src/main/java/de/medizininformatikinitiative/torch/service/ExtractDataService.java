...
public class ExtractDataService {
    ...
    public ExtractDataService(ResultFileManager resultFileManager,
        ...
        this.consentEvaluator = requireNonNull(consentEvaluator);
    ...
    public Mono<BatchResult> processBatch(BatchSelection selection) {
        ...
        Mono<PatientBatchWithConsent> batchWithConsent =
                consentEvaluator.evaluate(crtdl, batch)
                        .flatMap(maybePeriods -> maybePeriods
                                .map(periods -> patientBatchWithConsent(batch, periods))
    ...
    private static Mono<PatientBatchWithConsent> patientBatchWithConsent(PatientBatch batch, Map<String, NonContinuousPeriod> periods) {
        try {

...
class JobDiagnosticsSummaryTest {
    ...
    class From {
        ...
        void singleCriterion_producesOneSummaryEntry() {
            var key = new CriterionKey(ExclusionKind.MUST_HAVE, "obs", null, null);
        ...
        void multipleCriteriaOfSameKind_aggregatesCounts() {
            var key1 = new CriterionKey(ExclusionKind.CONSENT, "a", null, null);
            var key2 = new CriterionKey(ExclusionKind.CONSENT, "b", null, null);
        ...
        void criteriaOfDifferentKinds_producesOneEntryPerKind() {
            var diag = new JobDiagnostics(JOB_ID, 30, 10, List.of(
                    new CriterionEntry(new CriterionKey(ExclusionKind.MUST_HAVE, null, null, null), new CriterionCounts(5, 0)),
                    new CriterionEntry(new CriterionKey(ExclusionKind.REFERENCE_NOT_FOUND, null, null, null), new CriterionCounts(0, 7))
            ));

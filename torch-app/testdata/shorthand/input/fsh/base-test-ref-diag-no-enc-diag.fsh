...
//Patient diag-no-enc-diag
Instance: torch-test-diag-no-enc-diag-pat-1
...
// Encounter Patient-1
Instance: torch-test-diag-no-enc-diag-enc-1
...
* insert AddEncounter(MII_0000001, finished, IMP, einrichtungskontakt, normalstationaer, torch-test-diag-no-enc-diag-pat-1, 0100)
* period.start = "2024-02-14"
* period.end = "2024-02-22"
* diagnosis[0].condition = Reference(torch-test-diag-no-enc-diag-diag-1)
* diagnosis[0].use = $diagnosis-role#AD "Admission diagnosis"
* diagnosis[0].rank = 1
* diagnosis[1].condition = Reference(torch-test-diag-no-enc-diag-diag-2)
...
// Diagnosis Diabetes
Instance: torch-test-diag-no-enc-diag-diag-1
...
* insert AddDiagnose(E13.0, 2023, torch-test-diag-no-enc-diag-pat-1, 2024-02-12, Diabetes)
* onsetDateTime = "2024-02-21"
* recordedDate = "2024-02-21"

// Other Diag Ref by Diab Enc
Instance: torch-test-diag-no-enc-diag-diag-2
InstanceOf: https://www.medizininformatik-initiative.de/fhir/core/modul-diagnose/StructureDefinition/Diagnose
//* meta.profile[0] = "https://www.medizininformatik-initiative.de/fhir/core/modul-diagnose/StructureDefinition/Diagnose|2024.0.0"
* insert AddDiagnose(E13.0, 2023, torch-test-diag-no-enc-diag-pat-1, 2024-02-12, Diabetes)
* onsetDateTime = "2024-02-01"
* recordedDate = "2024-02-22"
* encounter =  Reference(torch-test-diag-no-enc-diag-enc-1)


// Other Diag not Ref by Diab Enc
Instance: torch-test-diag-no-enc-diag-diag-3
InstanceOf: https://www.medizininformatik-initiative.de/fhir/core/modul-diagnose/StructureDefinition/Diagnose
//* meta.profile[0] = "https://www.medizininformatik-initiative.de/fhir/core/modul-diagnose/StructureDefinition/Diagnose|2024.0.0"
* insert AddDiagnose(E-NOT-REF, 2023, torch-test-diag-no-enc-diag-pat-1, 2024-02-12, Diag not ref by diab enc)

...
class ProvisionExtractorTest {
    ...
    void extractsNestedPermitWithMissingAndPresentPeriods() throws Exception {
        ...
        ConsentProvisions result = extractor.extractProvisionsPeriodByCode("123", consent, Set.of(CODE_1, CODE_2, CODE_3));
    ...
    @Test
    void skipsIrrelevantCodes() throws ConsentViolatedException {
        Consent consent = new Consent();
        ...
        ConsentProvisions result = extractor.extractProvisionsPeriodByCode("123", consent, Set.of(CODE_1));
    ...
    void skipsProvisionWithYearOnlyDates() throws Exception {
        ...
        ConsentProvisions result =
                extractor.extractProvisionsPeriodByCode("123", consent, Set.of(CODE_1));
    ...
    @Test
    void extractsNestedDeny() throws ConsentViolatedException {
        Consent consent = new Consent();
    ...
    void ignoresProvisionWithNoCode() throws Exception {
        ...
        ConsentProvisions result = extractor.extractProvisionsPeriodByCode("123", consent, Set.of(CODE_1, CODE_2));
    ...
    void throwsExceptionWhenNoConsentDate() {
        ...
        assertThatThrownBy(() -> extractor.extractProvisionsPeriodByCode("123", consent, Set.of(CODE_1)))
    ...
    void extractsNestedMultipleCodeableConceptsAndCodings() throws Exception {
        ...
        ConsentProvisions result = extractor.extractProvisionsPeriodByCode("123", consent, requiredCodes);
    ...
    void throwsConsentViolatedException_whenConsentTimeIsEmpty_withNestedProvision() {
        ...
        assertThatThrownBy(() ->
                extractor.extractProvisionsPeriodByCode("123", consent, Set.of(CODE_2))
        ).isInstanceOf(ConsentViolatedException.class)
                .hasMessageContaining("consent-empty-date has no valid consent date");
    }
    ...
    void throwsConsentViolatedException_whenConsentTimeIsNull() {
        ...
        assertThatThrownBy(() ->
                extractor.extractProvisionsPeriodByCode("123", consent, Set.of(new TermCode("sys", "anyCode")))
        ).isInstanceOf(ConsentViolatedException.class)
                .hasMessageContaining("consent-null-date has no valid consent date");
    }

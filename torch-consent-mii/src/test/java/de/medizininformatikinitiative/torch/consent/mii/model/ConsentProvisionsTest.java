...
class ConsentProvisionsTest {
    ...
    @Test
    void updateByEncounters_codeNotAdjustable_returnsProvisionUnchanged() {
        TermCode gateCode = new TermCode("sys1", "gate-code");
        Provision p1 = new Provision(gateCode, Period.of(LocalDate.of(2025, 9, 10), LocalDate.of(2025, 9, 30)), true);
        ConsentProvisions consent = new ConsentProvisions("patient1", null, List.of(p1));
